...
- **Pulido visual** (25/7): títulos `h2` con separación de letras y contorno color marca (mejor legibilidad, se adapta a ambos temas); contador "+X Años de experiencia" calculado en el navegador a partir del año de fundación (2016), sube solo cada febrero; foto del equipo con anillo color marca al hover; footer "HEFESTO" con la fuente Impact (antes Georgia, no coincidía con el logo) y contorno blanco
